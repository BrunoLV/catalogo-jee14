...
public class LivroDao {
    ...
    /**
     * Metodo utilizada para inserir um registro de livro na tabela de banco de
     * dados.
     *
     * @param livro
     * @return
    ...
    /**
     * Metodo utilizado para atualizar um registro de livro na tabela de banco
     * de dados.
     *
     * @param livro
     * @throws DaoException
    ...
    /**
     * Metodo utilizado para deletar um registro de livro da tabela de banco de
     * dados.
     *
     * @param codigo
     * @throws DaoException
    ...
    /**
     * Metodo utilizado para buscar um registro de livro na tabela de banco de
     * dados utilizando o codigo.
     *
     * @param codigo
     * @return
     * @throws DaoException
    ...
    /**
     * Metodo utilizado para buscar todos registro de livro na tabela de banco
     * de dados.
     *
     * @return
     * @throws DaoException
